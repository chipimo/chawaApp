const Colors = {
  ...
  gradientSlpBegin: '#0A1142',
  gradientSlpEnd: '#5A33A1',
  highlight: '#acacd2',
  inputIcons:'#FF3424',
  inputLayout:'rgba(0,0,0,0.4)',
...
export const DarkAppTheme = {
  ...
  colors: {
    ...
    inputLayoutColors:{
      Icons: Colors.inputIcons,
      inputLayout:Colors.inputLayout,
      borderColor:'#F86E11'
    },
    gradientsBgTop: Colors.gradientSlpBegin,
    gradientsBgBottom: Colors.gradientSlpEnd,
    gradients: {
      base: [
