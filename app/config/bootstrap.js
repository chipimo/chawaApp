...
import { DarkAppTheme } from './darkTheme';
import { AppTheme } from "./theme";
import { data } from '../data';

export const bootstrap = () => {
  RkTheme.setTheme(AppTheme, null);
  StatusBar.setBarStyle('light-content', true);

  data.getTheme('theme', defaultTheme => {
    if (defaultTheme === 'dark') { 
      RkTheme.setTheme(DarkAppTheme, null); 
      StatusBar.setBarStyle('light-content', true);
    }
  })
  /*
  ...
  */
  ...
  RkTheme.setType('RkText', 'facebook', {
    fontSize: theme => theme.fonts.sizes.s6,
    fontFamily: theme => theme.fonts.family.bold,
